	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
        ...
        <view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
			...
			<view v-if="queryIndex==0" class="search-form round">
				...
				<input v-model="searchForm.xuehao" type="text" placeholder="学号" ></input>
			</view>
		...
		<button :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","backgroundColor":"#409EFF","borderColor":"#409EFF","borderRadius":"40rpx","color":"#fff","borderWidth":"1","width":"80%","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' v-if="isAuth('yonghu','新增')" class="add-btn" @click="onAddTap()">新增</button>
		...
		methods: {
			...
			async search(){
				...
				let searchForm = {
					...
					searchForm['xuehao'] = '%' + this.searchForm.xuehao + '%'
				}	
