<template>
	<view class="content">
		<view class="forget-bg">
			<view class="forget-card" :style='{"boxShadow":"","backgroundColor":"#fff","borderColor":"rgba(74, 209, 242, 1)","borderRadius":"40rpx","borderStyle":"solid","borderWidth":"2rpx"}'>
				<view class="forget-input forget-margin-b">
					<input v-model="username" :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"20rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' type="text" placeholder="请输入您的账号" />
				</view>
		...
		<view class="forget-btn">
			<button class="landing" :style='{"borderColor":"#ccc","backgroundColor":"rgba(241, 229, 98, 1)","borderRadius":"40rpx","color":"#333","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}' @tap="onResetPass" type="primary">重置密码</button>
		</view>
	</view>
</template>
